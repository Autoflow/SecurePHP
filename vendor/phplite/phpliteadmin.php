...
if($language != 'en') {
 	$temp_lang=$lang;
	if(is_file('../../../securephp/1.1/languages/lang_'.$language.'.php'))
		include('../../../securephp/1.1/languages/lang_'.$language.'.php');
	elseif(is_file('../../../securephp/1.1/lang_'.$language.'.php'))
		include('../../../securephp/1.1/lang_'.$language.'.php');
...
<link rel="shortcut icon" href="../../../securephp/1.1/?resource=favicon" />
...
?>
<!-- JavaScript Support -->
<script type='text/javascript' src='../../../securephp/1.1/?resource=javascript'></script>
</head>
<body style="direction:<?php echo $lang['direction']; ?>;">
<?php
